...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lesson_duration_hours', models.PositiveIntegerField(default=lessons.models.BookedLesson.getLessonDuration)),
                ('approval_time', models.DateTimeField(auto_now_add=True)),
                ('extra_requests', models.CharField(default=lessons.models.BookedLesson.getExtraRequests, max_length=250)),
